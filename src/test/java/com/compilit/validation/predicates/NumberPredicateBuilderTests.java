...
class NumberPredicateBuilderTests {
  ...
  void validate_integerMatchingRule_shouldReturnTrue() {
    var value = 2;
    var rule0 = Definitions.defineThatIt(NumberPredicate.isEqualTo(2)).otherwiseReport("failure");
    var rule1 = Definitions.defineThatIt(NumberPredicate.isBetween(1).and(5)).otherwiseReport("failure");
    var rule2 = Definitions.defineThatIt(NumberPredicate.isBetween(5).and(1)).otherwiseReport("failure");
    var rule3 = Definitions.defineThatIt(NumberPredicate.hasAmountOfDigits(1)).otherwiseReport("failure");
    var rule4 = Definitions.defineThatIt(NumberPredicate.contains(2, 2)).otherwiseReport("failure");
    var rule5 = Definitions.defineThatIt(NumberPredicate.doesNotContain(43, 123)).otherwiseReport("failure");
    var rule6 = Definitions.defineThatIt(NumberPredicate.isNotNull()).otherwiseReport("failure");
    var rule7 = Definitions.defineThatIt(NumberPredicate.isEqualTo(2).and(NumberPredicate.isEqualTo(2).and(NumberPredicate.isEqualTo(2)))).otherwiseReport("failure");
  ...
  void validate_integerNotMatchingRule_shouldReturnFalse() {
    var value = 2;
    var rule0 = Definitions.defineThatIt(NumberPredicate.isEqualTo(1)).otherwiseReport("failure");
    var rule1 = Definitions.defineThatIt(NumberPredicate.isBetween(5).and(50)).otherwiseReport("failure");
    var rule2 = Definitions.defineThatIt(NumberPredicate.isBetween(50).and(5)).otherwiseReport("failure");
    var rule3 = Definitions.defineThatIt(NumberPredicate.hasAmountOfDigits(10)).otherwiseReport("failure");
    var rule4 = Definitions.defineThatIt(NumberPredicate.isEqualTo(5435)).otherwiseReport("failure");
    var rule5 = Definitions.defineThatIt(NumberPredicate.doesNotContain(2, 2)).otherwiseReport("failure");
    var rule6 = Definitions.defineThatIt(NumberPredicate.isNotNull()).otherwiseReport("failure");
    var rule7 = Definitions.defineThatIt(NumberPredicate.isEqualTo(2).and(NumberPredicate.isEqualTo(2).and(NumberPredicate.isEqualTo(1)))).otherwiseReport("failure");
  ...
  void validate_extendedTests() {
    var value = 123456789;
    var rule1 = Definitions.defineThatIt(NumberPredicate.contains(1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 23, 789)).otherwiseReport("failure");
    var rule2 = Definitions.defineThatIt(NumberPredicate.contains(10,
            11,
            22,
            33,
            44,
