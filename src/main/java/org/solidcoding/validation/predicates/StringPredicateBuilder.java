...
public final class StringPredicateBuilder extends ObjectPredicateBuilder<String> {
  ...
  private StringPredicateBuilder(final Predicate<String> predicate) {
    super(predicate);
  }
   ...
   */
  public static PredicateConnector<Integer, Predicate<String>> hasALengthBetween(final int length) {
    return new StringLengthConstraintPredicateConnectorBuilder(length);
  }
