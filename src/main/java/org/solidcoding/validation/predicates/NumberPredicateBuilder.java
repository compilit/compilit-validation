...
public final class NumberPredicateBuilder extends ObjectPredicateBuilder<Integer> {
  ...
  private NumberPredicateBuilder(final Predicate<Integer> predicate) {
    super(predicate);
  }
   ...
   */
  public static PredicateConnector<Integer, Predicate<Integer>> isBetween(final int first) {
    return new NumberConstraintPredicateConnectorBuilder(first, new ObjectPredicateBuilder<>());
  }
